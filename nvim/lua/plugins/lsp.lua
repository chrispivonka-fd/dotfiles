...
-- Server choices (basedpyright+ruff, vtsls) kept from the original setup;
-- blink.cmp, mason-tool-installer, and the modern vim.lsp.config API are
-- picked up from the dotfiles audit.
-- =============================================================================
